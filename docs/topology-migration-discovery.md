...
Issue: #36  
Governance authority: `SemperSupra/engineering-governance-private#66`
...
|---|---|---|
| `mona-actions/gh-stats` | rich organization/repository inventory | strongest primary candidate; resumable JSON, dry-run estimates, Actions, Pages, packages, webhooks, custom properties |
| `mona-actions/gh-repo-stats` | migration inventory baseline | simpler and GitHub-documented; useful comparison/control collector |
| `mona-actions/gh-repo-map` | dependency-edge discovery | promising for repository dependencies; requires empirical coverage test |
